...
NOTE: the archetype used to build this has been deprecated since camel 2.18...
...
And then you can install this example from its shell:
    ...
    osgi:install -s mvn:com.asodc.camel/cxf-contract-first-blueprint/1.0-SNAPSHOT
